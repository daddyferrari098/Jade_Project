...
public class ComposedJourney implements Serializable {
    ...
    public static void main(String[] args) {
        agencesVoyages.data.JourneysList journeysList = new agencesVoyages.data.JourneysList();
        journeysList.addJourney(new agencesVoyages.data.Journey("Val", "Lille", "car", 1440, 30, 10));
        journeysList.addJourney(new agencesVoyages.data.Journey("Val", "Lille", "train", 1440, 40, 10));
        journeysList.addJourney(new agencesVoyages.data.Journey("Val", "Lille", "car", 1510, 30, 10));
        journeysList.addJourney(new agencesVoyages.data.Journey("Lille", "Dunkerque", "car", 1500, 40, 10));
        journeysList.addJourney(new agencesVoyages.data.Journey("Lille", "Dunkerque", "car", 1600, 40, 10));
        journeysList.addJourney(new agencesVoyages.data.Journey("Lille", "Dunkerque", "car", 1630, 40, 10));
        journeysList.addJourney(new agencesVoyages.data.Journey("Dunkerque", "Bray-Dunes", "car", 1700, 10, 10));
        journeysList.addJourney(new agencesVoyages.data.Journey("Dunkerque", "Bray-Dunes", "car", 1710, 20, 10));
     ...
     * list)
     *
     * @param oneJourney journey to add at the end of the current composed journey
     */
     ...
     *
     * @param journeysList list of journeys to add at the end of the current composed
     *                     journey
     */
    ...
    /**
     * @param _normCost the normCost to set
     */
    ...
    /**
     * @param _normCo2 the normCo2 to set
     */
    ...
    /**
     * @param _normConfort the normConfort to set
     */
    ...
    /**
     * @param _normDuration the normDuration to set
     */
