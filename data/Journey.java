...
public class Journey implements Cloneable, Serializable, Comparable<Journey> {
    ...
    private static final String NBPLACES = ", nb place(s) : ";
    /**
     * origin
     */
    String start;
    ...
    public Journey(final String _start, final String _stop, final String _means, final int _departureDate,
        ...
        //nombre de places selon le moyen de transport
        if(_means.equals("car")) { places = 3; }
        if(_means.equals("bus")) { places = 50; }
        if(_means.equals("train")) { places = 200; }
    }
    ...
    public String toString() {
        return new StringBuilder(Journey.TRAJECTFROM).append(start).append(Journey.TO).
                ...
                append(Journey.COST).append(cost).append(Journey.NBPLACES).append(places)
                .append(Journey.PROPOSEDBY).append(proposedBy).toString();
    }
